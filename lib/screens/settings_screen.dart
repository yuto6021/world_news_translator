                  ...
                  return Column(
                    ...
                    children: [
                      SwitchListTile(
                        ...
                        subtitle:
                            const Text('フォントサイズ / 行間 / ハイコントラスト / 代替フォント'),
                        value: enabled,
                        onChanged: (v) =>
                            ReadingModeService.instance.setEnabled(v),
                      ),
                      if (enabled) ...[
                        ValueListenableBuilder<double>(
                          valueListenable:
                              ReadingModeService.instance.fontScale,
                          builder: (context, scale, __) => Column(
                            ...
                            children: [
                              ...
                              Slider(
                                ...
                                onChanged: (v) =>
                                    ReadingModeService.instance.setFontScale(v),
                              ),
                            ],
                          ),
                        ),
                        ValueListenableBuilder<double>(
                          valueListenable:
                              ReadingModeService.instance.lineHeight,
                          builder: (context, lh, __) => Column(
                            ...
                            children: [
                              ...
                              Slider(
                                ...
                                onChanged: (v) => ReadingModeService.instance
                                    .setLineHeight(v),
                              ),
                            ],
                          ),
                        ...
                        ValueListenableBuilder<bool>(
                          valueListenable:
                              ReadingModeService.instance.highContrast,
                          builder: (context, hc, __) => SwitchListTile(
                            title: const Text('ハイコントラスト'),
                            value: hc,
                            onChanged: (v) =>
                                ReadingModeService.instance.setHighContrast(v),
                          ),
                        ),
                        ValueListenableBuilder<bool>(
                          valueListenable:
                              ReadingModeService.instance.dyslexicFont,
                          builder: (context, df, __) => SwitchListTile(
                            title: const Text('代替フォント (可読性向上)'),
                            value: df,
                            onChanged: (v) =>
                                ReadingModeService.instance.setDyslexicFont(v),
                          ),
                        ),
                        const Divider(),
                      ],
