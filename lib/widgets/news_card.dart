    ...
    return ValueListenableBuilder<bool>(
      ...
      builder: (context, hoverEnabled, _) {
        ...
        return TweenAnimationBuilder<double>(
          ...
          builder: (context, animValue, child) {
            return Opacity(
              ...
              child: Transform.translate(
                offset: Offset(0, 18 * (1 - animValue)), // 下から18pxスライドイン
                child: child,
              ),
            );
          },
          child: MouseRegion(
            onEnter:
                hoverEnabled ? (_) => setState(() => _hovered = true) : null,
            onExit:
                hoverEnabled ? (_) => setState(() => _hovered = false) : null,
